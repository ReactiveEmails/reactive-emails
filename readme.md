...
```text
Raw Reactive Hash = Last 5 digits of base8(SHA256(amazon1mysecret))
Raw Reactive Hash = Last 5 digits of base8(0xc4ceceb5aa775497eeb009790bd212b52960cd7889dc90a203b37520033dceab)
Raw Reactive Hash = 47253 (base 8)
```
...
Final Reactive Email   = amazon1nzhqm@example.com
```
...
```text
New Raw Reactive Hash = Last 5 characters of base8(SHA256(amazon2mysecret))
New Raw Reactive Hash = 51630 (base 8)
Final Reactive Hash   = qdvmb
```

Thus, our new reactive email for Amazon would be `amazon2qdvmb@example.com`.
